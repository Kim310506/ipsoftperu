...
const agregarVisitante = async () => {
  try {
    ...
    await api.post(
      `/contratas/token/${token}/trabajadores`,
      form
    );
...
async () => {
  ...
  await api.put(
    ...
    `/contratas/trabajadores/${trabajadorEditando.id}`,
...
const finalizarRegistro = async () => {
  ...
  !ctaExistente
    ...
    await api.put(
  `/contratas/token/${token}/nivel-riesgo`,
  {
    nivelRiesgo
  }
);
  ...
  await api.post(
    `/contratas/token/${token}/documento/SCTR`,
    sctrData
  );
    ...
    if (cmFile) {
      ...
      await api.post(
        `/contratas/token/${token}/documento/CM`,
        cmData
      );
    ...
    if (ctaFile) {
      ...
      await api.post(
        `/contratas/token/${token}/documento/CTA`,
        ctaData
      );
