// src/pages/modulos/rondas/components/SidebarRondas.jsx
...
export default function SidebarRondas({
  menuActivo,
  setMenuActivo,
  cerrarSesion,
}) {
    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-3 p-5">
          ...
          {roles.includes("JEFE DE SEGURIDAD") && (
            <>
              <MenuButton
                menu="inicio"
                icon={Home}
